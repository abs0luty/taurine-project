...
static inline double tauClock() {
  ...
  return TAU_CAST(double, (counter.QuadPart * 1000 * 1000 * 1000) /
...
#define TAU_TEST_INITIALIZER(f)                                                \
  ...
  __pragma(comment(linker, "/include:" TAU_SYMBOL_PREFIX #f "_"))              \
      TAU_C_FUNC __declspec(allocate(".CRT$XCU")) void(__cdecl * f##_)(void) = \
          f;                                                                   \
  static void __cdecl f(void)
#else
#define TAU_TEST_INITIALIZER(f)                                                \
...
TAU_WEAK TAU_OVERLOADABLE void
TAU_OVERLOAD_PRINTER(const long long unsigned int i);
...
#define TAU_OVERLOAD_PRINTER(...)                                              \
  ...
  tauPrintf("If you think this was an error, please file an issue on Tau's "   \
            "Github repo.")
...
#define REQUIRE_NE(actual, expected)                                           \
  __TAUCMP__(actual, expected, !=, "", REQUIRE_NE,                             \
             TAU_ABORT_IF_INSIDE_TESTSUITE)
#define REQUIRE_LT(actual, expected)                                           \
  __TAUCMP__(actual, expected, <, " ", REQUIRE_LT,                             \
             TAU_ABORT_IF_INSIDE_TESTSUITE)
#define REQUIRE_LE(actual, expected)                                           \
  __TAUCMP__(actual, expected, <=, "", REQUIRE_LE,                             \
             TAU_ABORT_IF_INSIDE_TESTSUITE)
#define REQUIRE_GT(actual, expected)                                           \
  __TAUCMP__(actual, expected, >, " ", REQUIRE_GT,                             \
             TAU_ABORT_IF_INSIDE_TESTSUITE)
#define REQUIRE_GE(actual, expected)                                           \
...
#define CHECK_STRNE(actual, expected)                                          \
...
#define REQUIRE_STREQ(actual, expected)                                        \
  __TAUCMP_STR__(actual, expected, !=, ==, not equal, REQUIRE_STREQ,           \
                 TAU_ABORT_IF_INSIDE_TESTSUITE)
#define REQUIRE_STRNE(actual, expected)                                        \
  __TAUCMP_STR__(actual, expected, ==, !=, equal, REQUIRE_STRNE,               \
                 TAU_ABORT_IF_INSIDE_TESTSUITE)

// Substring Checks
#define CHECK_SUBSTREQ(actual, expected, n)                                    \
  __TAUCMP_STRN__(actual, expected, n, !=, ==, unequal substrings,             \
                  CHECK_SUBSTREQ, TAU_FAIL_IF_INSIDE_TESTSUITE)
#define CHECK_SUBSTRNE(actual, expected, n)                                    \
  __TAUCMP_STRN__(actual, expected, n, ==, !=, equal substrings,               \
                  CHECK_SUBSTRNE, TAU_FAIL_IF_INSIDE_TESTSUITE)
#define REQUIRE_SUBSTREQ(actual, expected, n)                                  \
  __TAUCMP_STRN__(actual, expected, n, !=, ==, unequal substrings,             \
                  REQUIRE_SUBSTREQ, TAU_ABORT_IF_INSIDE_TESTSUITE)
#define REQUIRE_SUBSTRNE(actual, expected, n)                                  \
  __TAUCMP_STRN__(actual, expected, n, ==, !=, equal substrings,               \
                  REQUIRE_SUBSTRNE, TAU_ABORT_IF_INSIDE_TESTSUITE)

// Buffer Checks
#define CHECK_BUF_EQ(actual, expected, n)                                      \
  __TAUCMP_BUF__(actual, expected, n, !=, ==, not equal, CHECK_BUF_EQ,         \
                 TAU_FAIL_IF_INSIDE_TESTSUITE)
#define CHECK_BUF_NE(actual, expected, n)                                      \
  __TAUCMP_BUF__(actual, expected, n, ==, !=, equal, CHECK_BUF_NE,             \
                 TAU_FAIL_IF_INSIDE_TESTSUITE)
#define REQUIRE_BUF_EQ(actual, expected, n)                                    \
  __TAUCMP_BUF__(actual, expected, n, !=, ==, not equal, REQUIRE_BUF_EQ,       \
                 TAU_ABORT_IF_INSIDE_TESTSUITE)
#define REQUIRE_BUF_NE(actual, expected, n)                                    \
...
#define REQUIRE_TRUE(cond)                                                     \
  __TAUCMP_TF(cond, false, true, !, REQUIRE_TRUE, TAU_ABORT_IF_INSIDE_TESTSUITE)
#define REQUIRE_FALSE(cond)                                                    \
  __TAUCMP_TF(cond, true, false, , REQUIRE_FALSE, TAU_ABORT_IF_INSIDE_TESTSUITE)
...
#define CHECK_1_ARGS(cond)                                                     \
  __TAUCHECKREQUIRE__(cond, TAU_FAIL_IF_INSIDE_TESTSUITE, CHECK, "FAILED")
#define CHECK_2_ARGS(cond, message)                                            \
  __TAUCHECKREQUIRE__(cond, TAU_FAIL_IF_INSIDE_TESTSUITE, CHECK, message)
#define CHECK_MACRO_CHOOSER(...)                                               \
  GET_3RD_ARG(__VA_ARGS__, CHECK_2_ARGS, CHECK_1_ARGS, )

#define REQUIRE_1_ARGS(cond)                                                   \
  __TAUCHECKREQUIRE__(cond, TAU_ABORT_IF_INSIDE_TESTSUITE, REQUIRE, "FAILED")
#define REQUIRE_2_ARGS(cond, message)                                          \
  __TAUCHECKREQUIRE__(cond, TAU_ABORT_IF_INSIDE_TESTSUITE, REQUIRE, message)
#define REQUIRE_MACRO_CHOOSER(...)                                             \
  GET_3RD_ARG(__VA_ARGS__, REQUIRE_2_ARGS, REQUIRE_1_ARGS, )
...
static void tau_help_() {
  ...
  printf("  --filter=<filter>        Filter the test suites to run (e.g: "
         "Suite1*.a\n");
  printf("                             would run Suite1Case.a but not "
         "Suite1Case.b}\n");
#if defined(TAU_WIN_)
  ...
  printf("  --output=<FILE>          Write an XUnit XML file to Enable XUnit "
         "output\n");
...
inline int tau_main(const int argc, const char *const *const argv) {
  ...
  if (tauStatsNumTestsFailed > 0) {
    ...
    printf("No test suites were found. If you think this was an error, please "
           "file an issue on Tau's Github repo.");
    printf("\n");
  }
